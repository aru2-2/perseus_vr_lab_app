        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const LazyImage(assetPath: 'lib/assets/images/perseus_uga_presentation_2025.JPG'),


              const SizedBox(height: 25),
              // Description of UGA presentation in 2025
              const Text(
                "Some of the Warnell VR Lab interns presented about forests in a virtual world at the 2025 PERSEUS Annual Meeting at the University of Georgia." 
                " Their presentation demonstrated initial research into using virtual reality headsets to advance the PERSEUS Project objectives.",
                textAlign: TextAlign.center,
                style: TextStyle(
                  fontSize: 18,
                  height: 1.6,
